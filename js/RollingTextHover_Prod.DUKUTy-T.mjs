import{t as e}from"./rolldown-runtime.uXsZyavj.mjs";import{E as t,L as n,c as r,l as i,o as a}from"./react.CiYLx6f6.mjs";import{S as o,t as s}from"./motion.BCMFzRVg.mjs";import{K as c,O as l,i as u}from"./framer.QjlUq91e.mjs";function stableId(str){let h=5381;for(let i=0;i<(str||'').length;i++){h=((h<<5)+h)+str.charCodeAt(i)|0}return Math.abs(h).toString(16).padStart(8,'0')+'-1234-4abc-89ab-'+Math.abs(h^0xdeadbeef).toString(16).padStart(12,'0')}function d({text:e,transition:t,stagger:a,reverse:s,font:c,color:l,textTransform:u,tag:d,padding:p}){let[m,h]=n(!1),g=`rolling-text-inner-${stableId(e)}`,_=d,v=c?.fontSize??`16px`;c?.letterSpacing;let y=c?.lineHeight,b=c?.fontFamily??`Inter`,x=parseInt(v,10)||16,S;if(typeof y==`number`)S=x*y;else if(typeof y==`string`&&y.includes(`em`))S=x*(parseFloat(y)||1.2);else if(typeof y==`string`){let e=parseFloat(y);S=isNaN(e)?y:`${e}px`}else S=x*1.2;let C=typeof S==`number`?`${S}px`:S,w=`-${C}`,T=`
    .${g} {
      --font-size: ${v};
      --text: ${l};
      --line-height-abs: ${C};
